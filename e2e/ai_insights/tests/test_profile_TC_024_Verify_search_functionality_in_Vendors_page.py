...
def test_Verify_search_functionality_in_Vendors_page(guest_user):
    ...
    # Vendor search
    actual_model_appeared = profile_page.verify_model_search_functionality(created_vendor_name)

    check.equal(actual_model_appeared, created_vendor_name, f"Vendor mismatch: Expected '{created_vendor_name}', but got '{actual_model_appeared}'")
    print(f"➡️ Validating Vendor: Expected='{created_vendor_name}', Actual='{actual_model_appeared}'")
