...
def test_Verify_Super_Admin_menu_shows_additional_options(guest_user):
    ...
    visibility = home_page.verify_super_admin_dropdown()
    ...
    print("\n🔍 Super Admin drop down Visibility Report:")
