...
def test_profile_TC_013_Create_a_new_Model(guest_user):
    ...
    # Delete Model
    profile_page.delete_model(created_model_name)

    check.equal(actual_edit_status, True, f"failed to delete model: Expected '{"True"}', but got '{actual_edit_status}'")
    print(f"➡️ is new Model Deleted : Expected='{"True"}', Actual='{actual_edit_status}'")